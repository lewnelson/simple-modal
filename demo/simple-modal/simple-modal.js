...
function SimpleModal(options) {
   ...
   */
  function getTheme() {
    if(typeof setOptionsObject.theme !== 'undefined') {
      return setOptionsObject.theme;
    }
  ...
  function getTitleElementTag() {
    if(typeof setOptionsObject.titleTag !== 'undefined') {
      return setOptionsObject.titleTag;
    }
    ...
    setOptionsObject.titleTag = titleTag;
    return titleTag;
  }
  ...
  this.show = function(callback) {
    ...
    if(theme !== null) {
      newModal.classList.add('simple-modal-' + theme);
    }
